...
namespace Gebraucht_und_Gut.Controllers
{
    public class KundesController : Controller
    {
        ...
        public KundesController(Gebraucht_und_GutContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("KundeId,Name,Vorname")] Kunde kunde)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KundeId,Name,Vorname")] Kunde kunde)
        {
            if (id != kunde.KundeId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Gebraucht_und_GutContext.Kundes'  is null.");
            }
            var kunde = await _context.Kundes.FindAsync(id);
            if (kunde != null)
            {
